...
## OUTPUT:
<img width="1090" height="176" alt="image" src="https://github.com/user-attachments/assets/b0f2fb81-254c-492a-a1c6-09e29c16495a" />



## RESULT:
The host took 0.895907 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.133526 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
